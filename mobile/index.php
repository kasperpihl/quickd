...
<html>
    ...
    <script type="text/javascript" src="<?= ROOT_URL ?>app/libs/scroller-min.js"></script>
    <script type="text/javascript" src="<?= ROOT_URL ?>app/libs/EasyScroller.js"></script>
    ...
    <?php if($live){ ?>
        <script type="text/javascript" src="<?= ROOT_URL ?>touch/sencha-touch.js"></script>
        <script type="text/javascript" src="<?= ROOT_URL ?>app-all.js"></script>
    <? } else{ ?>
